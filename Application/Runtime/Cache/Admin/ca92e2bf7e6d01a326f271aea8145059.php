...
<div class="table-css">
    <div id="content_wares">
        <div id="content_page">
            <div>
                <ul >
                    <?php if(is_array($wares)): $i = 0; $__LIST__ = $wares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li data-sku="1591280" class="gl-item gl-item-presell">
                            <div class="gl-i-wrap">
                                <div class="p-img">
                                ...
                                <div class="p-commit" data-done="1">
                                    ...
                                    <strong><?php echo ($vo["w_talk"]); ?></strong>
                                </div>
                                ...
                                <div class="p-operate">
                                    <a class="p-o-btn rushbuy" href="#" target="_blank"  style="color: red; border:1px red solid;" >参与抢购</a>
                                </div>
                                </a>
                            </div>
