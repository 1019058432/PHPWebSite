...
<body>
  <div id="header_padding">
    <div class="menu-content">
        ...
        <?php if($admin == ''): ?><ul >
                ...
                <li class="active" id="shell_class_list">
  ...
  <script src="/tp/Public/static/js/bootstrap.min.js"></script>
    ...
    <div class="table-css">
        ...
        <?php if(is_array($wares)): $i = 0; $__LIST__ = $wares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td >
                    <div >
                        <span style="width: 40px;text-align: center" ><?php echo ($vo["w_stock"]); ?></span>
                    </div>
                </td>
                <td>
                    <a href="<?php echo U('Crud/upM?w_id='.$vo['w_id']);?>"   class=" btn ">修改</a>
                    <a href="<?php echo U('Crud/delsid?w_id='.$vo['w_id']);?>" class="cart-follow" id="follow" >下架商品</a>
                </td>
