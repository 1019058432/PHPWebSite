...
<script>
    $(function () {
        ...
        $("#upwd").click(function () {
            ...
            $.post("/tp/index.php/Admin/User/address",{Email:email,PASSWORD:newpwd,fr:"upwd"},function (str) {
                alert(str)
            })
        })
        $("#uaddre").click(function () {
            let address=$("#addre").val()
            $.post("/tp/index.php/Admin/User/address",{address:address,fr:"uaddre"},function (str) {
                alert(str)
            })
        })
    })
