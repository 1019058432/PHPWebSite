...
<div class="wrap table-css">
    <form action="/tp/index.php/Admin/Crud/addM" method="post">
        <div style="margin-left: 150px">商品名：<br><textarea style="width: 900px;height: 80px" name="w_name"><?php echo ($list["w_name"]); ?></textarea></div>
        <div class="prosum_box">
            <dl class="prosum_left">
                <dt>
                    <img alt="" class="big_img" src="<?php echo ($list["w_img"]); ?>" οnerrοr="this.οnerrοr='';this.src='http://www.jinmalvyou.com/Public/uploads/goods_img/img_size4/201703/m49788843d72171643297ccc033d9288ee.jpg'">
                </dt>
                <dd id="dd">
                    <a class="up_img up_img_disable"></a>添加图片连接
            ...
            <div class="prosum_right">
                <p class="pros_title"><span id="rname"> 【描述：】</span></p>
