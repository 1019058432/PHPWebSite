            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav navbar-right">
                <?php if($admin_name == ''): ?><li><a href="<?php echo U('Index/login');?>" >登录</a></li>
                  ...
                  <?php else: ?>
                  <li><nobr><a href="../Users/User/user"><span style="font-size: 8px;text-overflow:ellipsis;width: 80px"><?php echo ($admin_name); ?>,你好!</span></a>
...
<div id="content">
    <div class="list-group" id="list_g">
        ...
        <a href="#" class="list-group-item" data-show="new_pwd">修改密码</a>
        <a href="#" class="list-group-item" data-show="address">收货地址管理</a>
    </div>
    <div id="u_menu22">
        <div id="new_pwd">
        ...
        <div id="address">
            ...
            <form action="">
                <table>
                    <tr><td><input id="addre" name="PASSWORD" type="text" placeholder="葫芦岛上海路不知村"></td></tr>
...
<script>
    $(function () {
        ...
        $("#upwd").click(function () {
            ...
            $.post("/tp/index.php/Admin/Users/address",{Email:email,PASSWORD:newpwd,fr:"upwd"},function (str) {
                alert(str)
            })
        })
        $("#uaddre").click(function () {
            let address=$("#addre").val()
            $.post("/tp/index.php/Admin/Users/address",{address:address,fr:"uaddre"},function (str) {
                alert(str)
            })
        })
    })
