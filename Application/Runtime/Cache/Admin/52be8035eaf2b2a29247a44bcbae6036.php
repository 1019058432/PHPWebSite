<?php if (!defined('THINK_PATH')) exit();?><DOCTYPE html>
    ...
    <head>
        ...
        <style>
            ...
            .regibox{ margin:50px 0px 30px 40px;
                width: 500px;
                float:left;
            }
            table tr{
            ...
            #username,#passwd,#email,#data,#color,#checkcode{border:1px solid #A6A6A6;
                height:32px;
                width:200px;
                padding-left:5px;
                border-radius:5px;
    ...
    <div class="box">
        <div class="left">
            <p class=" leftp">新用户注册</p>
            <p class=" leftp2">USER REGISTER</p>
        </div>
        <div class="regibox">
            <form action="register" method="post" id="form" >
                <table>
                    ...
                    <tr><td>密码:</td><td><input name="PASSWORD" type="password" placeholder="passwd" id="passwd"></td><td><span id="p_erro" class="erro"></span><td></tr>

                    <tr><td>邮箱：</td><td><input type="email"  id="email" name="Email"></td><td></td></tr>
                    <tr><td>验证码:</td><td><input type="text"  id="checkcode" name="checkcode"><img  id="codeimg"  src="/tp/index.php/Admin/Index/vcode"><td><td><?php echo ($error_code); ?></td></tr>
                    <tr ><td colspan="2" align="center"><input type="submit" value="注册" id="regisbt"></td></tr>
                </table>
            </form>
        </div>
        ...
        <div class="right">
            ...
            <p>已有账号？</p>
            <a href="../../Admin/Index/login">立即登录</a>
        </div>
    </div>
    <footer id="footer">
        <!DOCTYPE html>
