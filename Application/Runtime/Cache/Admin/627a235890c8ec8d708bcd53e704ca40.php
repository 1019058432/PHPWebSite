        ...
        <div class="list_one">
            <table>
                ...
                <?php if(is_array($unpaids)): $i = 0; $__LIST__ = $unpaids;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td >
                            <strong id="price"><?php echo ($vo["w_price"]); ?></strong>
                        </td>
                        <td >
                            <div >
                                <span style="width: 40px;text-align: center" ><?php echo ($vo["p_count"]); ?></span>
                            </div>
                        </td>
                        <td>
                            <a href="#" id="to"   class=" btn " data-wstock="<?php echo ($vo["w_stock"]); ?>" data-wid="<?php echo ($vo["w_id"]); ?>" data-wname="<?php echo ($vo["w_name"]); ?>" data-wprice="<?php echo ($vo["w_price"]); ?>">再来一单</a>
                            <a href="/tp/index.php/Admin/Wares/delpaidhistory?up_id=<?php echo ($vo["up_id"]); ?>" class="cart-follow" id="follow" >删除订单记录</a>
                            <div style="display: none">
                                <span id="<?php echo ($vo["w_id"]); ?>"><?php echo ($vo["w_id"]); ?></span>
                            </div>
                        </td>
